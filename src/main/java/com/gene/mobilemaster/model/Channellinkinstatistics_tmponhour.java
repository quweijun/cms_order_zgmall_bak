...
public class Channellinkinstatistics_tmponhour {
    private Long flowno;

    private Date linkindate;

    private Integer linkinhour;
    ...
    public Integer getLinkinhour() {
        return linkinhour;
    }

    public void setLinkinhour(Integer linkinhour) {
        this.linkinhour = linkinhour;
    }
