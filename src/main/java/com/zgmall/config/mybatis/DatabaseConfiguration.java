...
//@Configuration
//@MapperScan(basePackages = "com.zgmall.mapper", sqlSessionTemplateRef = "masterSqlSessionTemplate",markerInterface=MyMapper.class)
@ConfigurationProperties(prefix = "spring.datasource") //接收application.yml中的spring.datasource文件中的属性
